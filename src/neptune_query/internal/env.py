...
NEPTUNE_QUERY_MAX_WORKERS = EnvVariable[int]("NEPTUNE_QUERY_MAX_WORKERS", int, 10)
...
NEPTUNE_QUERY_ATTRIBUTE_VALUES_BATCH_SIZE = EnvVariable[int](
    "NEPTUNE_QUERY_ATTRIBUTE_VALUES_BATCH_SIZE", int, 10_000
)
