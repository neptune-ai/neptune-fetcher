...
def split_attribute_filters(
    _attribute_filter: filters.AttributeFilter,
) -> list[filters.AttributeFilterMatch]:
    if isinstance(_attribute_filter, filters.AttributeFilterMatch):
        return [_attribute_filter]
    elif isinstance(_attribute_filter, filters.AttributeFilterAlternative):
...
def fetch_attribute_definitions_single_filter(
    ...
    attribute_filter: filters.AttributeFilterMatch,
