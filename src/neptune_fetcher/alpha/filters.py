...
class _AlphaInternalAssociativeOperator(_filters._AssociativeOperator):
    """
    A version of internal.filters._AssociativeOperator that skips validation and allows empty filters.
    """

    def __post_init__(self) -> None:
        # Skip validation since we're allowing empty filters (only for alpha!)
        pass
