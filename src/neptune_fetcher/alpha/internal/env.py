...
NEPTUNE_FETCHER_EXPERIMENT_SYS_ATTRS_BATCH_SIZE = EnvVariable[int](
    "NEPTUNE_FETCHER_EXPERIMENT_SYS_ATTRS_BATCH_SIZE", int, 9_400
)  # query size limit results in a limit of about 4710, so 9400 is the closest value to 10k that avoids an awkward split
