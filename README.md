...
| `names_regex`              | `str`, optional                               | `None`              | A regex pattern to filter the experiments by name.                                                                                                                                                                                                                                                                                                 |
| `names_regex_neg`          | `str`, optional                               | `None`              | A regex pattern to exclude the experiments by name.  Any experiment matching this regex will not be returned in the result.                                                                                                                                                                                                                        |
