...
def test__eager_loading_structure(project, all_experiment_ids):
    ...
    run_no_eager = ReadOnlyRun(project, custom_id=all_experiment_ids[0], eager_load_structure=False)
...
def test__lazy_loading_structure_to_access_fields(project, all_experiment_ids):
    run = ReadOnlyRun(project, custom_id=all_experiment_ids[0], eager_load_structure=False)
