...
from neptune_fetcher.alpha.internal.api_client.client import (
    clear_cache,
    get_client,
)
...
def mock_networking():
    with (
        patch(
            "neptune_fetcher.alpha.internal.api_client.client.get_config_and_token_urls"
        ) as get_config_and_token_urls,
        patch("neptune_fetcher.alpha.internal.api_client.client.create_auth_api_client") as create_auth_api_client,
    ):
